...
export function AboutMe(props) {
  return (
    <section className="flex justify-around h-screen bg-white" id="sobre-mim">
      ...
      <div className="flex flex-col justify-center gap-4">
        <span className="bg-back-0 rounded-md font-raleway font-bold w-28 text-detail-0">🧐 Sobre mim</span>

        <h2 className="font-raleway font-bold text-5xl">{nome}</h2>

        <p className="text-back-0/80 font-raleway font-bold text-2xl">
          👋 Me chamo {nome}, mas pode me chamar apenas de Lázaro. Prazer!
        </p>

        <span>
          <p className="text-back/75 font-raleway font-bold">
          ...
          <p className="text-back/75 font-raleway font-bold">💡 Interesses em desenvolvimento Front-end com React.
          </p>
        </span>

        <p className="text-back-0/50 font-raleway font-bold">
