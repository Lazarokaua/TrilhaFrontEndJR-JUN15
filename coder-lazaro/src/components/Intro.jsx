...
export function Intro(props) {
  return (
    <section className="bg-custom-background bg-cover bg-center flex justify-around h-screen tablet:flex-col-reverse tablet:items-center tablet:justify-center tablet:text-center mobile:flex-col-reverse mobile:items-center mobile:justify-center mobile:text-center ">
      <div className="flex flex-col gap-6 justify-center desktop:p-6 tablet:items-center mobile:items-center">
        ...
        <p className="text-detail-0/65 font-raleway font-bold desktop:text-3xl laptop:text-xl tablet:text-xs">Front-end developer · BI analyst · AI Knowledge</p>
      ...
      <div className="flex flex-col justify-center mb-16 desktop:p-6 laptop:p-3 desktop:items-center tablet:items-center mobile:gap-2">
        <img src={props.profile} alt="Lázaro programador" className="tv:w-96 tv:h-96 rounded-full drop-shadow-2xl contrast-100 desktop:h-64 desktop:w-64 laptop:w-32 h-32 tablet:w-28 tablet:h-28" />
